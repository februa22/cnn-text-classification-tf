...
class MultiClassDataLoader(object):
    ...
    def define_flags(self):
        self.__flags.DEFINE_string("train_data_file", "./data/cnn4nlu.train", "Data source for the training data.")
        self.__flags.DEFINE_string("dev_data_file", "./data/cnn4nlu.dev", "Data source for the cross validation data.")
        self.__flags.DEFINE_string("class_data_file", "./data/cnn4nlu.cls", "Data source for the class list.")
    ...
    def __load_data_and_labels(self, data_file):
        x_text = []
        y = []
        with open(data_file, 'rt', encoding='UTF8') as tsvin:
    ...
    def __classes(self):
        ...
        if self.__classes_cache is None:
            with open(self.__class_data_file, 'rt', encoding='UTF8') as catin:
